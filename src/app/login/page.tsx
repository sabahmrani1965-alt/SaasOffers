      ...
      <div className="w-full max-w-md sm:max-w-lg">
        <div className="bg-white border border-gray-100 rounded-2xl p-8 sm:p-10 shadow-xl shadow-gray-100/80">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-900 text-base mt-2 font-medium">Sign in to your SaaSOffers account</p>
          </div>
          ...
          <p className="text-center text-sm text-gray-900 font-medium mt-6">
