      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-8">
          {[
            ...
            {
              title: 'Your Rights',
              content: 'You have the right to access, correct, or delete your personal data at any time. To request deletion of your account and associated data, contact us at privacy@saasoffers.com.',
            },
            {
            ...
            {
              title: 'Contact',
              content: 'For privacy inquiries, contact us at privacy@saasoffers.com.',
            },
          ].map(section => (
